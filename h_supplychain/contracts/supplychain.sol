...
contract Supply_Chain {
    ...
    function make_Product(
        ...
        arryC.push(product_hash);//saving product hash to changing ownership;
        product[product_hash] = new_product;

        return product_hash;
    }
//============================================================
function E_shippedCarToCustomer(address payable _manufacturerAddress , bytes32 _manufacturerProductHash)public payable{
    // payment
      require(_manufacturerAddress ==  product[_manufacturerProductHash].manufacturer,"Manufacturer Address Not Right");
      require(msg.value == product[_manufacturerProductHash].price,"Manufacturer Price And You Price Not Same");
    _manufacturerAddress.transfer(msg.value);
    //transfering Ownership
    product[_manufacturerProductHash].manufacturer = msg.sender;
